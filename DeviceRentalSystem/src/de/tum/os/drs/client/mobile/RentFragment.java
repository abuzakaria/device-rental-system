	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFindButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	if (mIMEI.getText().length()>0)
            	{
            		...
            		Toast.makeText(getActivity(), "Search failed: Empty serial", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mRentButton.setOnClickListener(new View.OnClickListener() {
			...
			private void populateRenterList() {
				...
				public void onSuccess(List<Renter> result) {
					...
					renterSpinner.setAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_dropdown_item, m_rentersName));
				}
        ...
        renterSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				//Toast.makeText(getActivity(), m_renters.get(arg2).getName(), Toast.LENGTH_SHORT).show();
			}
			...
			private void displayDetails(Renter d) {
				...
				temp += "Mat. No: ";
				temp += d.getMatriculationNumber()==null ? "<None>": d.getMatriculationNumber();  
				temp += "\n";				
				
				temp += "Phone: ";
				temp += d.getPhoneNumber() == null ? "<None>": d.getPhoneNumber().toString();  
				temp += "\n";
            	...
            	if (sIMEI != null && sMatNo !=null)
            	{
                	...
                	service.rentDevices(new RentRequest(sMatNo, imeis, getDateFromDatePicker(datepicker), "some comments", "Signature"), new Callback<String>(){
    					...
    					public void onSuccess(String result) {
    						...
    						final FragmentTransaction ft = getFragmentManager().beginTransaction(); 
    						ft.replace(R.id.frame_container, new DeviceFragment(), "NewFragmentTag"); 
    						ft.commit(); 
    					}
